...
public class SushimanMatematicoTest extends TestCase {
    ...
    */
	...
	public void testGetSuperPrimos() {
        ...
        Assert.assertEquals(listaResultadosTeste, SushimanMatematico.getSuperPrimos(0)); // Falha teria q retornar o mesmo valor que com as entradas >=9 no m�todo.
       
        Assert.assertEquals(listaResultadosTeste, SushimanMatematico.getSuperPrimos(-1)); // Falha teria q retornar o mesmo valor que com as entradas >=9 no m�todo.
        
        Assert.assertEquals(listaResultadosTeste, SushimanMatematico.getSuperPrimos(-8)); // Falha teria q retornar o mesmo valor que com as entradas >=9 no m�todo.
